        ...
        <React.Fragment>          
             <div className="fixed-nav sticky-footer" id="page-top">
                ...
                <nav className="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
                    <a className="navbar-brand" href="index.html"><img src="img/logo.png" data-retina="true" alt width={150} height={36} /></a>
...
document.writeln("<script type='text/javascript' src='assets/admin/js/admin-charts.js'></script>");
